<script lang="ts">
    ...
    //import SetLoginUte, { setLoginUte } from '../components/NavBar.svelte';

    import test,{setLoginUte} from '../components/NavBar.svelte';
    ...
    function submit(Event){
       ...
       function setResult(res){
            ...
            if(res.id === "OK"){
             ...
             // childstatusbar.SetLoginUte(res.ragsoc.ragsoc);
             {setLoginUte}
            }else{
  ...
  <!-- <SetLoginUte bind:this="{childstatusbar}" /> -->
 
  <!-- svelte-ignore missing-declaration -->
  <!-- <NavBar uteauth="claudio" /> -->
  <!-- svelte-ignore missing-declaration -->
  <div class="py-4 box">
